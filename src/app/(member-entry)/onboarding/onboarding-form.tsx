...
export function OnboardingForm() {
  ...
  const continueToMemberEntry = useCallback(async () => {
    const entry = await apiFetch('/api/member-entry', {
      schema: MemberEntryResponse,
    });
  ...
  const handleAddInterest = useCallback(() => {
    ...
    form.setValue('interests', [...existing, trimmed], {
      shouldValidate: true,
    });
    setNewInterest('');
  }, [form, newInterest]);
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
      ...
      <Card className="border-border/70 bg-card shadow-sm">
        <CardHeader>
          ...
          <CardDescription>You can edit any of this from your profile at any time.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
