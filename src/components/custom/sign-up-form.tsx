...
// set by the catch-all route handler and a soft-nav advances to /onboarding.
//
...
export function SignUpForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const message = aborted ? "Sign-up didn't complete. Please try again." : getErrorMessage(err);
      setError(message);
      toast.error(message);
    } finally {
